...
class TestH2HTiebreak:
    ...
    """
    def test_basic_h2h(self, tiebreaker):
        for _ in range(10):
            h2h = {
            ...
            reordered = tiebreaker.h2h_tiebreak(h2h, team_order, point_map)
            assert reordered == ["Team D", "Team B", "Team A", "Team C"]

    def test_3x3_h2h(self, tiebreaker):
        for _ in range(10):
            h2h = {
    ...
    def test_lower_seed_h2h(self, tiebreaker):
        for _ in range(10):
            h2h = {
    ...
    def test_random_h2h(self, tiebreaker):
        ranks = {
...
class TestBoundaryTiebreak:
    def test_no_tiebreak_needed(self, tiebreaker):
    ...
    def test_3x3_tiebreak(self, tiebreaker):
    ...
    def test_4x4_tiebreak(self, tiebreaker):
